...
[在线预览](http://demo.bi-admin.com/)

测试用户名：admin

测试密码：123456

> bi-admin是一个基于vue和gin开发的全栈前后端分离的后台管理系统，集成jwt鉴权，动态路由，动态菜单，casbin鉴权，表单生成器，代码生成器等功能，提供多种示例文件，让您把更多时间专注在业务开发上。

### 1.2 贡献指南
Hi! 首先感谢你使用 bi-admin。

bi-admin 是一套为后台管理平台准备的一整套前后端分离架构式的开源框架，旨在快速搭建后台管理系统。

bi-admin 的成长离不开大家的支持，如果你愿意为 bi-admin 贡献代码或提供建议，请阅读以下内容。
...
- [bi-admin_v2.0_dev](https://github.com/flipped-aurora/bi-admin/tree/bi-admin_v2_dev) （v2.0 不再兼容 v1.0）

- [bi-admin_v1.0_stable](https://github.com/flipped-aurora/bi-admin/tree/bi-admin_v1_stable) （v1.0停止维护）

- [bi-admin_v1.0_dev](https://github.com/flipped-aurora/bi-admin/tree/bi-admin_v1_dev) （v1.0停止维护）
...
```bash
# clone the project
git clone https://github.com/piexlmax/bi-admin.git
...
![系统架构图](http://qmplusimg.henrongyi.top/gva/bi-admin.png)
...
### QQ交流群：622360840
### 微信交流群：可以添加上面任意一位开发者，备注"加入bi-admin交流群"
