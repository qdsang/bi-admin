...
export default {
  ...
  methods: {
    getList() {
      this.loading = true
      dashboardList(this.projectId).then(resp => {
        this.loading = false
        this.dashboardList = []
        ...
        if (this.currentDashboard) {
          this.$router.push(`${this.projectPath}/dashboard?id=${this.currentDashboard.dashboard_id}`).catch(_ => {})
        }
      })
    },
    switchDb(db) {
      ...
      this.$router.push(`${this.projectPath}/dashboard?id=${this.currentDashboard.dashboard_id}`)
      // })
    },
    addDashboard() {
      this.dbObj = {}
