...
#copy go app
COPY --from=builder /go/src/bi-admin/gvadmin ./
COPY --from=builder /go/src/bi-admin/db.db ./
COPY --from=builder /go/src/bi-admin/config.yaml ./
COPY --from=builder /go/src/bi-admin/resource ./resource
